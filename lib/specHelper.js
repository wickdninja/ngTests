    ...
    var specHelper = (function() {
        var service = {
            ...
            fakeTemplateCacheProvider: fakeTemplateCacheProvider,
        ...
        function fakeTemplateCacheProvider($provide) {
            $provide.value('$templateCache', sinon.stub());
        }

        function fakeHttpProvider($provide) {
            /**
             * Stub out the $httpProvider so we avoid
             * all http calls, which runs on every test otherwise.
             * Make sure this goes before the inject in the spec.
             */
